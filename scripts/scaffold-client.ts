...
function updateProjectMetadata(clientRoot: string, intake: ClientIntake) {
  ...
  const readme = [
    ...
    '',
    'The main nav navigates between these pages (like the finished site); the footer',
    'also carries a full site map. All wireframe pages have `noindex` metadata until built out.',
    '',
    '## Building out pages',
    '',
