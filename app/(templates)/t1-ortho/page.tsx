      ...
      <section className="min-h-[80vh] grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative min-h-[400px] lg:min-h-0 order-2 lg:order-1">
          ...
          <div className="absolute bottom-8 left-8 right-8">
            ...
            <p className="text-sm text-white/80">Dedicated to your perfect smile</p>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center px-8 lg:px-16 py-16 bg-brand-canvas order-1 lg:order-2">
          ...
          <div className="flex items-center gap-8 mt-12 pt-8 border-t border-neutral-border">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-brand-mainText">Board Certified</p>
                <p className="text-xs text-neutral-muted">Orthodontist</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-brand-primary/10 flex items-center justify-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-brand-mainText">10,000+</p>
                <p className="text-xs text-neutral-muted">Smiles Created</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-8 lg:px-16 bg-slate-800">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Bio Content */}
            <div>
              <p className="text-sky-400 uppercase tracking-widest text-sm mb-4">Meet Your Orthodontist</p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-8 border-t border-gray-700">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-sky-400">10,000+</p>
