...
const navLinks = [
  ...
  { href: "#", label: "Your Orthodontist" },
  { href: "#", label: "Contact" },
];

const serviceLinks = [
  { href: "#", label: "Invisalign", description: "Clear aligner therapy" },
  { href: "#", label: "Braces for Kids", description: "Early intervention care" },
  { href: "#", label: "Teen Treatment", description: "Options for teenagers" },
  { href: "#", label: "Adult Orthodontics", description: "It's never too late" },
  { href: "#", label: "Retainers", description: "Maintain your results" },
];

export default function O3Nav() {
    ...
    <header className="sticky top-0 z-50 bg-brand-canvas border-b border-neutral-border">
      <div className="max-w-4xl mx-auto px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/o3" className="flex items-center">
            <Image
