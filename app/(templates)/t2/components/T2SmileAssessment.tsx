      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="t2p fixed inset-0 z-[60] flex items-center justify-center p-4 bg-[rgba(16,22,29,0.45)] backdrop-blur-sm"
            onClick={(e) => {
            ...
            >
              ...
              <div className="sticky top-0 z-10 flex items-center justify-between border-b border-[var(--t2p-line)] bg-[var(--t2p-bg)] px-6 py-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    onClick={close}
                    className="flex h-9 w-9 items-center justify-center rounded-full border border-[var(--t2p-line-strong)] text-[var(--t2p-text-70)] hover:text-[var(--t2p-blue)] hover:border-[var(--t2p-blue)] transition-colors"
                            ...
                            >
                              <c.Icon
                                className={`mt-0.5 h-5 w-5 shrink-0 ${
                                  on ? "text-[var(--t2p-blue)]" : "text-[var(--t2p-text-50)]"
                                }`}
                                strokeWidth={1.25}
                                aria-hidden="true"
                              />
                              ...
                              {on && (
                                <Check
                                  className="absolute top-3 right-3 h-3.5 w-3.5 text-[var(--t2p-blue)]"
                                  strokeWidth={2}
                                  aria-hidden="true"
                                />
                              )}
                    ...
                    <motion.div key="photo" {...fade}>
                      ...
                      {photo && (
                        <button
                          ...
                          className="t2p-mono mt-3 text-[0.625rem] uppercase tracking-[0.16em] text-[var(--t2p-text-50)] hover:text-[var(--t2p-blue)] transition-colors"
                        >
                          Remove photo
                        </button>
                      )}
                  ...
                  {step === "complete" && (
                    <motion.div key="complete" {...fade} className="py-6 text-center">
                      ...
                      <div className="mt-8 flex flex-col items-center gap-3">
                        ...
                        <button
                          onClick={close}
                          className="t2p-mono text-[0.625rem] uppercase tracking-[0.18em] text-[var(--t2p-text-50)] hover:text-[var(--t2p-blue)] transition-colors"
                        >
                          Close
                        </button>
                      </div>
