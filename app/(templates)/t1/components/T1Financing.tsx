...
export default function T1Financing({
  ...
  return (
    <Fade>
      <div className="grid grid-cols-1 gap-px border border-[rgba(26,23,19,0.15)] bg-[rgba(26,23,19,0.15)] lg:grid-cols-3">
        {/* Financing plans */}
        <div className="bg-[#F3EFE6] p-6 md:p-8">
          ...
          <ul className="mt-5">
            {PLANS.map((plan, i) => (
              <li
                key={plan.title}
                className="border-t border-[rgba(26,23,19,0.15)] py-4 first:border-t-0 first:pt-0"
              >
                <p className="flex items-baseline gap-3">
                  <span className="t1-mono-label t1-mono-label-red shrink-0">
                    [ {String(i + 1).padStart(2, "0")} ]
                  </span>
                  <span className="font-t1-press text-lg uppercase leading-none text-[#1A1713]">
                    {plan.title}
                  </span>
                </p>
                <p className="mt-2 pl-[2.75rem] font-sans text-sm leading-relaxed text-[#6B675E]">
                  {plan.note}
                </p>
              </li>
            ))}
        ...
        <div className="bg-[#F3EFE6] p-6 md:p-8">
          ...
          <p className="mt-5 max-w-prose font-sans text-sm leading-[1.8] text-[#6B675E] md:text-base">
            {insuranceText}
          </p>
        </div>
        ...
        <div className="bg-[#F3EFE6] p-6 md:p-8">
          {membershipSummary ? (
            ...
            <>
              ...
              <p className="mt-5 font-sans text-sm leading-[1.8] text-[#6B675E] md:text-base">
                Call{" "}
