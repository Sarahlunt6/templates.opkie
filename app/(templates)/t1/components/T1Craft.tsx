...
export default function T1Craft({
  ...
  return (
    <div className="mx-auto max-w-5xl py-4 text-center">
      ...
      <Fade delay={0.08}>
        <h3 className="mx-auto mt-8 max-w-4xl font-t1-press text-[clamp(1.9rem,4.6vw,3.6rem)] uppercase leading-[1.02] text-[#1A1713]">
      ...
      <Fade delay={0.18}>
        <dl
          className={`mt-12 grid grid-cols-2 gap-px border border-[rgba(26,23,19,0.15)] bg-[rgba(26,23,19,0.15)] text-left ${
            avgRating !== null ? "lg:grid-cols-4" : ""
          }`}
        >
          {avgRating !== null && (
            <div className="flex flex-col-reverse gap-3 bg-[#F3EFE6] p-5 md:p-6">
              <dt className="t1-mono-label t1-mono-label-stone">
                AVG. PATIENT RATING
              </dt>
              <dd className="font-t1-press text-5xl leading-none text-[#D92B21] md:text-6xl">
          ...
          {reviewCount > 0 && (
            <div className="flex flex-col-reverse gap-3 bg-[#F3EFE6] p-5 md:p-6">
              ...
              <dd className="font-t1-press text-5xl leading-none text-[#1A1713] md:text-6xl">
