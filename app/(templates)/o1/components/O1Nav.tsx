...
const serviceLinks = [
  ...
  { href: "#", label: "Clear Braces", description: "Discreet orthodontic treatment" },
  { href: "#", label: "Retainers", description: "Post-treatment retention" },
  { href: "#", label: "Early Treatment", description: "Phase 1 orthodontics for children" },
];

export default function O1Nav() {
    ...
    <header className="sticky top-0 z-50 bg-brand-canvas border-b border-neutral-border">
      <div className="max-w-6xl mx-auto px-8 lg:px-16">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/o1" className="flex items-center">
            <Image
