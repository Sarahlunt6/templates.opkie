...
interface T2OrthoCinematicHeroProps {
  videoSrc?: string;
  posterSrc?: string;
  headline?: {
    line1: string;
...
export default function T2OrthoCinematicHero({
  videoSrc = "/videos/hero-ambient.mp4",
  posterSrc = "/images/team/staff-photo.jpg",
  headline = {
    line1: "iTero® 3D Scanning.",
    line2: "Propel® Accelerated Ortho.",
    accent: "Smiles in Record Time.",
  },
  subheadline = "Our iTero scanner captures 6,000 images per second for perfect aligner fit. Our Propel system reduces treatment time by 40% without compromising results. This is orthodontics without guesswork.",
  isMobile = false,
}: T2OrthoCinematicHeroProps) {
                  ...
                  <a
                    href={
                      clientMasterDataOrtho.onlineBookingUrl !== "none"
                        ? clientMasterDataOrtho.onlineBookingUrl
              ...
              <div className="relative lg:-ml-12">
                ...
                <div className="relative aspect-[4/3] max-w-lg ml-auto rounded-2xl border border-white/[0.05] bg-zinc-900/40 overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt={`The team at ${clientMasterDataOrtho.globalPracticeName}`}
                    fill
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-16">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/[0.04]">
            {[
              ...
              { value: "6,000", label: "Images per Second (iTero)" },
              { value: "40%", label: "Faster (Propel)" },
              { value: "1,800+", label: "Smiles Transformed" },
            ].map((stat, index) => (
              <motion.div
                key={index}
