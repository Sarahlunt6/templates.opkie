...
export default function Template3Page() {
  ...
  return (
    <div className="font-sans">
      ...
      <section className="py-20 px-8 bg-brand-canvas">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Individual Plan */}
            <div className="rounded-2xl bg-brand-primary/80 p-8 text-white">
            ...
            {/* Couple Plan */}
            <div className="rounded-2xl bg-neutral-muted/60 p-8 text-white">
            ...
            <div className="rounded-2xl bg-brand-primary p-8 text-white">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "2 Digital/3D X-ray",
                  "25% off All Procedures",
                  "Add up to 5 additional members for $95 each",
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-white" />
                    {item}
      ...
      {/* The Practice Difference - Full Width CTA */}
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/team/staff-photo.jpg"
        ...
        <div className="relative z-10 w-full px-8 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-200 leading-relaxed mb-10 max-w-2xl mx-auto italic">
              ...
              We&apos;re here to help you achieve and maintain excellent oral health.
            </p>
