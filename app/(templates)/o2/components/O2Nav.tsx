...
const serviceLinks = [
  ...
  { href: "#", label: "iTero Scanner", description: "Digital impressions" },
  { href: "#", label: "Clear Braces", description: "Ceramic bracket systems" },
  { href: "#", label: "Accelerated Treatment", description: "Faster results with technology" },
  { href: "#", label: "Virtual Monitoring", description: "Remote progress tracking" },
];

export default function O2Nav() {
    ...
    <header className="sticky top-0 z-50 bg-zinc-950/95 backdrop-blur-md border-b border-slate-800">
      <div className="max-w-6xl mx-auto px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/o2" className="flex items-center">
            <Image
