...
const services: Service[] = [
  {
    title: "Invisalign",
    description:
      "Discreet alignment therapy that works with your lifestyle. Clear, comfortable, and precisely planned for your perfect smile.",
    image: "/images/services/invisalign.jpg",
  },
  {
    title: "Traditional Braces",
    description:
      "Time-tested metal brackets with modern comfort features. Reliable results for all ages with precision-guided placement.",
    image: "/images/services/implant.jpg",
  },
  {
    title: "Ceramic Braces",
    description:
      "Tooth-colored brackets that blend naturally with your smile. Effective, discreet, and comfortable treatment option.",
    image: "/images/services/full-mouth-smile.jpg",
  },
  {
    title: "Early Treatment",
    description:
      "Phase 1 interceptive care for developing smiles. Guiding healthy jaw growth and alignment from the start.",
    image: "/images/services/full-mouth-shade.jpg",
  },
];

export default function T3OrthoServiceAccordion() {
