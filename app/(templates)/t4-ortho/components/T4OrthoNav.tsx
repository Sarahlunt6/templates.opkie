...
const serviceLinks = [
  ...
  { href: "#", label: "Ceramic Braces", description: "Discreet tooth-colored brackets" },
  { href: "#", label: "Teen Orthodontics", description: "Specialized teen treatment" },
  { href: "#", label: "Adult Orthodontics", description: "Never too late for a great smile" },
];

export default function T4OrthoNav() {
    ...
    <header className="sticky top-0 z-50 bg-brand-canvas border-b border-neutral-border">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/t4-ortho" className="flex items-center">
            <Image
